...
describe('ApiClientForApiKey', () => {
  ...
  describe('HTTP methods', () => {
    ...
    it('should handle GET requests', async () => {
      ...
      const responseFilter = new PersonDataSourceResponseStreamFilter({ fieldsToKeep: ['id'] });
  ...
  describe('error handling', () => {
    it('should propagate network errors', async () => {
      ...
      await expect(apiClient.get({ url: '/persons', responseFilter: new PersonDataSourceResponseStreamFilter(mockAxiosInstance) })).rejects.toThrow('Network Error');
    });
    ...
    it('should handle HTTP error responses', async () => {
      ...
      await expect(apiClient.get({ url: '/persons', responseFilter: new PersonDataSourceResponseStreamFilter(mockAxiosInstance) })).rejects.toEqual(httpError);
    });
  });
