...
import { ApiClientForApiKey, EndpointConfigForApiKey } from '../src/ApiClientForApiKey';
...
describe('ApiClientForApiKey', () => {
  ...
  describe('HTTP methods', () => {
    ...
    it('should handle GET requests', async () => {
      ...
      const result = await apiClient.get('/persons', params);
  ...
  describe('error handling', () => {
    it('should propagate network errors', async () => {
      ...
      await expect(apiClient.get('/persons')).rejects.toThrow('Network Error');
    });
    ...
    it('should handle HTTP error responses', async () => {
      ...
      await expect(apiClient.get('/persons')).rejects.toEqual(httpError);
    });
  });
