...
import { PersonDataSourceResponseStreamFilter } from '../src/stream/PersonDataSourceResponseStreamFilter';
...
describe('BuCdmPersonDataSource', () => {
  ...
  beforeEach(() => {
    ...
    const mockResponseFilter = new PersonDataSourceResponseStreamFilter({ fieldsToKeep: ['id'] });
  ...
  describe('Configuration and Timeout Precedence', () => {
    it('should prioritize endpointConfig timeout over integration timeout', () => {
      ...
      const dataSource = new BuCdmPersonDataSource({ config: configWithBothTimeouts, dataMapper: new DataMapper(), responseFilter: new PersonDataSourceResponseStreamFilter({ fieldsToKeep: ['id'] }) });
    ...
    it('should fallback to integration timeout when endpointConfig timeout is undefined', () => {
      ...
      const dataSource = new BuCdmPersonDataSource({ config: configWithOnlyIntegrationTimeout, dataMapper: new DataMapper(), responseFilter: new PersonDataSourceResponseStreamFilter({ fieldsToKeep: ['id'] }) });
