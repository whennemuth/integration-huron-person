...
describe('BuCdmPersonDataSource', () => {
  ...
  beforeEach(() => {
    ...
    dataSource = new BuCdmPersonDataSource({ config: mockConfig, dataMapper: new DataMapper() });
  ...
  describe('Configuration and Timeout Precedence', () => {
    it('should prioritize endpointConfig timeout over integration timeout', () => {
      ...
      const dataSource = new BuCdmPersonDataSource({ config: configWithBothTimeouts, dataMapper: new DataMapper() });
    ...
    it('should fallback to integration timeout when endpointConfig timeout is undefined', () => {
      ...
      const dataSource = new BuCdmPersonDataSource({ config: configWithOnlyIntegrationTimeout, dataMapper: new DataMapper() });
