...
describe('Package Exports', () => {
  ...
  describe('Export integrity', () => {
    ...
    it('should allow instantiation of all exported classes', () => {
      ...
      expect(() => new HuronPersonDataSource({ config: mockConfig, dataMapper: new DataMapper(), responseFilter: new PersonDataSourceResponseStreamFilter({ fieldsToKeep: ['id'] }) })).not.toThrow();
